        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                if len(ratios) == 10:
                    ...
                    print(f"Mean: {new_avg:.4f}")
                    if latest_avg is not None:
                        if new_avg < latest_avg * (1 - avg_tolerance):
                            print("Worsening orientation!")
                        elif new_avg > latest_avg * (1 + avg_tolerance):
                            print("Improving orientation!")
                    latest_avg = new_avg
